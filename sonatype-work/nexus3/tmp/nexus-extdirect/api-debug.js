...
NX.direct.api.REMOTING_API = {
  ...
  actions: {
    ...
    proui_TagList: [
      {
        name: 'readTags'/*() => java.util.List */,
        len: 0,
        formHandler: false
      },
      {
        name: 'readTagListDetails'/*(org.sonatype.nexus.extdirect.model.StoreLoadParameters) => java.util.List */,
        len: 1,
        formHandler: false
      },
      {
        name: 'getTag'/*(String) => com.sonatype.nexus.proui.internal.tag.TagDetailXO */,
        len: 1,
        formHandler: false
      }
    ],
    ...
    healthcheck_AssetDetail: [
      {
        name: 'identify'/*(String, String) => com.sonatype.nexus.plugins.healthcheck.pro.internal.ui.HealthCheckAssetDetailXO */,
        len: 2,
        formHandler: false
      }
    ],
